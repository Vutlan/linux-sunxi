...
static struct cpufreq_dvfs dvfs_table[] = {
    {.freq = 1104000000, .volt = 1500}, /* core vdd is 1.50v if cpu frequency is (1104Mhz, xxxxMhz] */
    {.freq = 1008000000, .volt = 1400}, /* core vdd is 1.40v if cpu frequency is (1008Mhz, 1104Mhz] */
    {.freq = 912000000,  .volt = 1350}, /* core vdd is 1.35v if cpu frequency is (912Mhz, 1008Mhz]  */
    {.freq = 864000000,  .volt = 1300}, /* core vdd is 1.30v if cpu frequency is (864Mhz, 912Mhz]   */
    {.freq = 624000000,  .volt = 1200}, /* core vdd is 1.20v if cpu frequency is (624Mhz, 864Mhz]   */
    ...
    {.freq = 240000000,  .volt = 900 }, /* core vdd is 0.90v if cpu frequency is (0, 240Mhz]        */
    {.freq = 0,          .volt = 800 }, /* end of cpu dvfs table                                    */
};
