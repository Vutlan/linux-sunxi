...
static struct core_pll_freq_tbl    CorePllTbl[] = {
    ...
    { 20,    0,    0,    1,    240000000 },   /* freq = (6M * 40 ), index = 40  */
    { 20,    0,    0,    1,    240000000 },   /* freq = (6M * 40 ), index = 41  */
    { 21,    0,    0,    1,    252000000 },   /* freq = (6M * 42 ), index = 42  */
    { 21,    0,    0,    1,    252000000 },   /* freq = (6M * 42 ), index = 43  */
    { 22,    0,    0,    1,    264000000 },   /* freq = (6M * 44 ), index = 44  */
    { 22,    0,    0,    1,    264000000 },   /* freq = (6M * 44 ), index = 45  */
