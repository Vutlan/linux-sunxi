...
static struct pll_freq_cfg_tbl    Pll1Tbl[] = {
    ...
    {9 , 0, 1, 0, 60000000  }, /* freq = (6M * 10 ), index = 10 */
    {10, 0, 3, 0, 66000000  }, /* freq = (6M * 11 ), index = 11 */
    {8 , 0, 1, 0, 72000000  }, /* freq = (6M * 12 ), index = 12 */
    {12, 0, 3, 0, 78000000  }, /* freq = (6M * 13 ), index = 13 */
    {13, 0, 1, 0, 84000000  }, /* freq = (6M * 14 ), index = 14 */
    {14, 0, 3, 0, 90000000  }, /* freq = (6M * 15 ), index = 15 */
    {11, 0, 1, 0, 96000000  }, /* freq = (6M * 16 ), index = 16 */
    ...
    {26, 0, 2, 0, 162000000 }, /* freq = (6M * 27 ), index = 27 */
    {13, 0, 0, 0, 168000000 }, /* freq = (6M * 28 ), index = 28 */
    {28, 0, 2, 0, 174000000 }, /* freq = (6M * 29 ), index = 29 */
    {14, 0, 1, 0, 180000000 }, /* freq = (6M * 30 ), index = 30 */
    {30, 0, 3, 0, 186000000 }, /* freq = (6M * 31 ), index = 31 */
    {15, 0, 0, 0, 192000000 }, /* freq = (6M * 32 ), index = 32 */
    {10, 2, 2, 0, 198000000 }, /* freq = (6M * 33 ), index = 33 */
    {16, 0, 1, 0, 204000000 }, /* freq = (6M * 34 ), index = 34 */
    {25, 0, 2, 0, 208000000 }, /* freq = (6M * 35 ), index = 35 */
    {8 , 0, 0, 0, 216000000 }, /* freq = (6M * 36 ), index = 36 */
    {27, 0, 3, 0, 224000000 }, /* freq = (6M * 37 ), index = 37 */
    {18, 0, 1, 0, 228000000 }, /* freq = (6M * 38 ), index = 38 */
    {12, 2, 3, 0, 234000000 }, /* freq = (6M * 39 ), index = 39 */
    {9 , 0, 0, 0, 240000000 }, /* freq = (6M * 40 ), index = 40 */
    {30, 0, 0, 0, 248000000 }, /* freq = (6M * 41 ), index = 41 */
    {20, 0, 1, 0, 252000000 }, /* freq = (6M * 42 ), index = 42 */
    {31, 0, 3, 0, 256000000 }, /* freq = (6M * 43 ), index = 43 */
    {10, 0, 0, 0, 264000000 }, /* freq = (6M * 44 ), index = 44 */
    {14, 2, 2, 0, 270000000 }, /* freq = (6M * 45 ), index = 45 */
    {22, 0, 1, 0, 276000000 }, /* freq = (6M * 46 ), index = 46 */
    {22, 1, 1, 0, 276000000 }, /* freq = (6M * 47 ), index = 47 */
    {11, 0, 0, 0, 288000000 }, /* freq = (6M * 48 ), index = 48 */
    {5 , 1, 3, 0, 288000000 }, /* freq = (6M * 49 ), index = 49 */
    {24, 0, 1, 0, 300000000 }, /* freq = (6M * 50 ), index = 50 */
    {16, 2, 2, 0, 306000000 }, /* freq = (6M * 51 ), index = 51 */
    {12, 0, 0, 0, 312000000 }, /* freq = (6M * 52 ), index = 52 */
    {19, 1, 2, 0, 320000000 }, /* freq = (6M * 53 ), index = 53 */
    {26, 0, 1, 0, 324000000 }, /* freq = (6M * 54 ), index = 54 */
    {8 , 2, 3, 0, 324000000 }, /* freq = (6M * 55 ), index = 55 */
    {13, 0, 0, 0, 336000000 }, /* freq = (6M * 56 ), index = 56 */
    {18, 2, 0, 0, 342000000 }, /* freq = (6M * 57 ), index = 57 */
    {28, 0, 1, 0, 348000000 }, /* freq = (6M * 58 ), index = 58 */
    {21, 1, 2, 0, 352000000 }, /* freq = (6M * 59 ), index = 59 */
    {14, 0, 0, 0, 360000000 }, /* freq = (6M * 60 ), index = 60 */
    {22, 1, 3, 0, 368000000 }, /* freq = (6M * 61 ), index = 61 */
    {30, 0, 2, 0, 372000000 }, /* freq = (6M * 62 ), index = 62 */
    {20, 2, 2, 0, 378000000 }, /* freq = (6M * 63 ), index = 63 */
    {15, 0, 0, 0, 384000000 }, /* freq = (6M * 64 ), index = 64 */
    {7 , 1, 0, 0, 384000000 }, /* freq = (6M * 65 ), index = 65 */
    {10, 2, 2, 0, 396000000 }, /* freq = (6M * 66 ), index = 66 */
    {24, 1, 3, 0, 400000000 }, /* freq = (6M * 67 ), index = 67 */
    {16, 0, 0, 0, 408000000 }, /* freq = (6M * 68 ), index = 68 */
    {22, 2, 2, 0, 414000000 }, /* freq = (6M * 69 ), index = 69 */
    {25, 1, 1, 0, 416000000 }, /* freq = (6M * 70 ), index = 70 */
    {12, 3, 3, 0, 416000000 }, /* freq = (6M * 71 ), index = 71 */
    {17, 0, 0, 0, 432000000 }, /* freq = (6M * 72 ), index = 72 */
    {8 , 1, 3, 0, 432000000 }, /* freq = (6M * 73 ), index = 73 */
    {27, 1, 3, 0, 448000000 }, /* freq = (6M * 74 ), index = 74 */
    {24, 2, 2, 0, 450000000 }, /* freq = (6M * 75 ), index = 75 */
    {18, 0, 0, 0, 456000000 }, /* freq = (6M * 76 ), index = 76 */
    {28, 1, 2, 0, 464000000 }, /* freq = (6M * 77 ), index = 77 */
    {12, 2, 2, 0, 468000000 }, /* freq = (6M * 78 ), index = 78 */
    {25, 2, 3, 0, 468000000 }, /* freq = (6M * 79 ), index = 79 */
    {19, 0, 0, 0, 480000000 }, /* freq = (6M * 80 ), index = 80 */
    {26, 2, 0, 0, 486000000 }, /* freq = (6M * 81 ), index = 81 */
    {26, 2, 1, 0, 486000000 }, /* freq = (6M * 82 ), index = 82 */
    {30, 1, 2, 0, 496000000 }, /* freq = (6M * 83 ), index = 83 */
    {20, 0, 0, 0, 504000000 }, /* freq = (6M * 84 ), index = 84 */
    {31, 1, 3, 0, 512000000 }, /* freq = (6M * 85 ), index = 85 */
    {15, 3, 0, 0, 512000000 }, /* freq = (6M * 86 ), index = 86 */
    {28, 2, 0, 0, 522000000 }, /* freq = (6M * 87 ), index = 87 */
    {21, 0, 0, 0, 528000000 }, /* freq = (6M * 88 ), index = 88 */
    {10, 1, 0, 0, 528000000 }, /* freq = (6M * 89 ), index = 89 */
    {14, 2, 1, 0, 540000000 }, /* freq = (6M * 90 ), index = 90 */
    {16, 3, 1, 0, 544000000 }, /* freq = (6M * 91 ), index = 91 */
    {22, 0, 0, 0, 552000000 }, /* freq = (6M * 92 ), index = 92 */
    {30, 2, 2, 0, 558000000 }, /* freq = (6M * 93 ), index = 93 */
    {23, 0, 1, 0, 576000000 }, /* freq = (6M * 94 ), index = 94 */
    {11, 1, 0, 0, 576000000 }, /* freq = (6M * 95 ), index = 95 */
    {7 , 2, 0, 0, 576000000 }, /* freq = (6M * 96 ), index = 96 */
    {5 , 3, 1, 0, 576000000 }, /* freq = (6M * 97 ), index = 97 */
    {23, 1, 1, 0, 576000000 }, /* freq = (6M * 98 ), index = 98 */
    {15, 2, 2, 0, 576000000 }, /* freq = (6M * 99 ), index = 99 */
    {24, 0, 0, 0, 600000000 }, /* freq = (6M * 100), index = 100*/
    {18, 3, 0, 0, 608000000 }, /* freq = (6M * 101), index = 101*/
    {16, 2, 1, 0, 612000000 }, /* freq = (6M * 102), index = 102*/
    {25, 0, 1, 0, 624000000 }, /* freq = (6M * 103), index = 103*/
    {12, 1, 0, 0, 624000000 }, /* freq = (6M * 104), index = 104*/
    {25, 1, 0, 0, 624000000 }, /* freq = (6M * 105), index = 105*/
    {12, 3, 1, 0, 624000000 }, /* freq = (6M * 106), index = 106*/
    {19, 3, 0, 0, 640000000 }, /* freq = (6M * 107), index = 107*/
    {26, 0, 1, 0, 648000000 }, /* freq = (6M * 108), index = 108*/
    {8 , 2, 2, 0, 648000000 }, /* freq = (6M * 109), index = 109*/
    {26, 1, 2, 0, 648000000 }, /* freq = (6M * 110), index = 110*/
    {17, 2, 0, 0, 648000000 }, /* freq = (6M * 111), index = 111*/
    {27, 0, 0, 0, 672000000 }, /* freq = (6M * 112), index = 112*/
    {13, 1, 0, 0, 672000000 }, /* freq = (6M * 113), index = 113*/
    {18, 2, 1, 0, 684000000 }, /* freq = (6M * 114), index = 114*/
    {28, 0, 2, 0, 696000000 }, /* freq = (6M * 115), index = 115*/
    {28, 1, 0, 0, 696000000 }, /* freq = (6M * 116), index = 116*/
    {28, 2, 1, 0, 696000000 }, /* freq = (6M * 117), index = 117*/
    {21, 3, 1, 0, 704000000 }, /* freq = (6M * 118), index = 118*/
    ...
    {22, 3, 1, 0, 736000000 }, /* freq = (6M * 123), index = 123*/
    {30, 0, 0, 0, 744000000 }, /* freq = (6M * 124), index = 124*/
    {30, 1, 1, 0, 744000000 }, /* freq = (6M * 125), index = 125*/
    {20, 2, 2, 0, 756000000 }, /* freq = (6M * 126), index = 126*/
    {31, 0, 0, 0, 768000000 }, /* freq = (6M * 127), index = 127*/
    {15, 1, 1, 0, 768000000 }, /* freq = (6M * 128), index = 128*/
    {7 , 3, 1, 0, 768000000 }, /* freq = (6M * 129), index = 129*/
    {31, 1, 1, 0, 768000000 }, /* freq = (6M * 130), index = 130*/
    {15, 3, 2, 0, 768000000 }, /* freq = (6M * 131), index = 131*/
    {10, 2, 0, 0, 792000000 }, /* freq = (6M * 132), index = 132*/
    {21, 2, 0, 0, 792000000 }, /* freq = (6M * 133), index = 133*/
    {24, 3, 0, 0, 800000000 }, /* freq = (6M * 134), index = 134*/
    {16, 1, 1, 0, 816000000 }, /* freq = (6M * 135), index = 135*/
    {16, 3, 1, 0, 816000000 }, /* freq = (6M * 136), index = 136*/
    {16, 3, 2, 0, 816000000 }, /* freq = (6M * 137), index = 137*/
    {22, 2, 2, 0, 828000000 }, /* freq = (6M * 138), index = 138*/
    {25, 3, 2, 0, 832000000 }, /* freq = (6M * 139), index = 139*/
    {17, 1, 2, 0, 864000000 }, /* freq = (6M * 140), index = 140*/
    {11, 2, 2, 0, 864000000 }, /* freq = (6M * 141), index = 141*/
    {8 , 3, 1, 0, 864000000 }, /* freq = (6M * 142), index = 142*/
    {23, 2, 1, 0, 864000000 }, /* freq = (6M * 143), index = 143*/
    {17, 3, 0, 0, 864000000 }, /* freq = (6M * 144), index = 144*/
    {26, 3, 1, 0, 864000000 }, /* freq = (6M * 145), index = 145*/
    {26, 3, 1, 0, 864000000 }, /* freq = (6M * 146), index = 146*/
    {26, 3, 1, 0, 864000000 }, /* freq = (6M * 147), index = 147*/
    {26, 3, 0, 0, 864000000 }, /* freq = (6M * 148), index = 148*/
    {26, 3, 1, 0, 864000000 }, /* freq = (6M * 149), index = 149*/
    {24, 2, 1, 0, 900000000 }, /* freq = (6M * 150), index = 150*/
    {24, 2, 1, 0, 900000000 }, /* freq = (6M * 151), index = 151*/
    {18, 1, 0, 0, 912000000 }, /* freq = (6M * 152), index = 152*/
    {18, 3, 0, 0, 912000000 }, /* freq = (6M * 153), index = 153*/
    ...
    {26, 2, 1, 0, 972000000 }, /* freq = (6M * 162), index = 162*/
    {26, 2, 1, 0, 972000000 }, /* freq = (6M * 163), index = 163*/
    {26, 2, 1, 0, 972000000 }, /* freq = (6M * 164), index = 164*/
    {26, 2, 1, 0, 972000000 }, /* freq = (6M * 165), index = 165*/
    {26, 2, 1, 0, 972000000 }, /* freq = (6M * 166), index = 166*/
    {26, 2, 0, 0, 972000000 }, /* freq = (6M * 167), index = 167*/
    {20, 1, 0, 0, 1008000000}, /* freq = (6M * 168), index = 168*/
    {13, 2, 0, 0, 1008000000}, /* freq = (6M * 169), index = 169*/
    {27, 2, 0, 0, 1008000000}, /* freq = (6M * 170), index = 170*/
    {20, 3, 0, 0, 1008000000}, /* freq = (6M * 171), index = 171*/
    {20, 3, 0, 0, 1008000000}, /* freq = (6M * 172), index = 172*/
    {20, 3, 1, 0, 1008000000}, /* freq = (6M * 173), index = 173*/
    {28, 2, 1, 0, 1044000000}, /* freq = (6M * 174), index = 174*/
    {21, 1, 1, 0, 1056000000}, /* freq = (6M * 175), index = 175*/
    {10, 3, 0, 0, 1056000000}, /* freq = (6M * 176), index = 176*/
    {10, 3, 1, 0, 1056000000}, /* freq = (6M * 177), index = 177*/
    {10, 3, 1, 0, 1056000000}, /* freq = (6M * 178), index = 178*/
    {10, 3, 1, 0, 1056000000}, /* freq = (6M * 179), index = 179*/
    {14, 2, 1, 0, 1080000000}, /* freq = (6M * 180), index = 180*/
    {29, 2, 1, 0, 1080000000}, /* freq = (6M * 181), index = 181*/
    {29, 2, 1, 0, 1080000000}, /* freq = (6M * 182), index = 182*/
    {29, 2, 1, 0, 1080000000}, /* freq = (6M * 183), index = 183*/
    {22, 1, 0, 0, 1104000000}, /* freq = (6M * 184), index = 184*/
    {22, 3, 0, 0, 1104000000}, /* freq = (6M * 185), index = 185*/
    {30, 2, 0, 0, 1116000000}, /* freq = (6M * 186), index = 186*/
    {30, 2, 1, 0, 1116000000}, /* freq = (6M * 187), index = 187*/
    {30, 2, 1, 0, 1116000000}, /* freq = (6M * 188), index = 188*/
    {30, 2, 1, 0, 1116000000}, /* freq = (6M * 189), index = 189*/
    {30, 2, 1, 0, 1116000000}, /* freq = (6M * 190), index = 190*/
    {30, 2, 1, 0, 1116000000}, /* freq = (6M * 191), index = 191*/
    ...
    {31, 2, 0, 0, 1152000000}, /* freq = (6M * 195), index = 195*/
    {23, 3, 0, 0, 1152000000}, /* freq = (6M * 196), index = 196*/
    {23, 3, 0, 0, 1152000000}, /* freq = (6M * 197), index = 197*/
    {23, 3, 0, 0, 1152000000}, /* freq = (6M * 198), index = 198*/
    {23, 3, 0, 0, 1152000000}, /* freq = (6M * 199), index = 199*/
    {24, 1, 0, 0, 1200000000}, /* freq = (6M * 200), index = 200*/
    {24, 1, 0, 0, 1200000000}, /* freq = (6M * 201), index = 201*/
    {24, 1, 1, 0, 1200000000}, /* freq = (6M * 202), index = 202*/
    {24, 1, 1, 0, 1200000000}, /* freq = (6M * 203), index = 203*/
    {16, 2, 1, 0, 1224000000}, /* freq = (6M * 204), index = 204*/
    {16, 2, 1, 0, 1224000000}, /* freq = (6M * 205), index = 205*/
    {16, 2, 1, 0, 1224000000}, /* freq = (6M * 206), index = 206*/
    {16, 2, 1, 0, 1224000000}, /* freq = (6M * 207), index = 207*/
    {25, 1, 0, 0, 1248000000}, /* freq = (6M * 208), index = 208*/
    {12, 3, 0, 0, 1248000000}, /* freq = (6M * 209), index = 209*/
    {25, 3, 1, 0, 1248000000}, /* freq = (6M * 210), index = 210*/
    {25, 3, 1, 0, 1248000000}, /* freq = (6M * 211), index = 211*/
    {25, 3, 1, 0, 1248000000}, /* freq = (6M * 212), index = 212*/
    {25, 3, 1, 0, 1248000000}, /* freq = (6M * 213), index = 213*/
    {25, 3, 1, 0, 1248000000}, /* freq = (6M * 214), index = 214*/
    {25, 3, 1, 0, 1248000000}, /* freq = (6M * 215), index = 215*/
    {26, 1, 0, 0, 1296000000}, /* freq = (6M * 216), index = 216*/
    {17, 2, 0, 0, 1296000000}, /* freq = (6M * 217), index = 217*/
    {26, 3, 0, 0, 1296000000}, /* freq = (6M * 218), index = 218*/
    {26, 3, 0, 0, 1296000000}, /* freq = (6M * 219), index = 219*/
    {26, 3, 0, 0, 1296000000}, /* freq = (6M * 220), index = 220*/
    {26, 3, 0, 0, 1296000000}, /* freq = (6M * 221), index = 221*/
    {26, 3, 0, 0, 1296000000}, /* freq = (6M * 222), index = 222*/
    {26, 3, 0, 0, 1296000000}, /* freq = (6M * 223), index = 223*/
