...
#define DEV_DBG_EN   		0 
#if(DEV_DBG_EN == 1)		
#define csi_dev_dbg(x,arg...) printk(KERN_INFO"[CSI_DEBUG][OV5640 MIPI]"x,##arg)
#else
#define csi_dev_dbg(x,arg...) 
#endif
#define csi_dev_err(x,arg...) printk(KERN_INFO"[CSI_ERR][OV5640 MIPI]"x,##arg)
#define csi_dev_print(x,arg...) printk(KERN_INFO"[CSI][OV5640 MIPI]"x,##arg)
...
//	{{0xff,0xff},{0x64}},
//	{{0x30,0x08},{0x42}},
//	{{0x30,0x07},{0xe7}},//disable MIPI clock
	{{0x31,0x03},{0x03}},
	{{0x30,0x17},{0x00}},		//disable DVP output
	{{0x30,0x18},{0x00}},		//disable DVP output
	{{0x36,0x30},{0x2e}},
	{{0x36,0x32},{0xe2}},
	{{0x36,0x33},{0x23}},
	{{0x36,0x34},{0x44}},
	...
	{{0x30,0x02},{0x1c}},
	{{0x30,0x06},{0xc3}},
	{{0x30,0x0e},{0x05|((2-1)<<6)}},	//bit[7:6]mipi lane number
	{{0x30,0x2e},{0x08}},
	{{0x36,0x12},{0x4b}},
	{{0x36,0x18},{0x00}},

	{{0x30,0x35},{0x51}},	//bit[3:0]mipi div 
	{{0x30,0x36},{0x54}},	//0x004a = 50M   //0x56:
	{{0x30,0x37},{0x13}},
	{{0x31,0x08},{0x01}},
	{{0x37,0x08},{0x64}},
	{{0x37,0x09},{0x12}},
	...
	{{0x38,0x06},{0x07}},
	{{0x38,0x07},{0x9b}},
	{{0x38,0x08},{0x02}},//horizontal size
	{{0x38,0x09},{0x80}},
	{{0x38,0x0a},{0x01}},//vertical size
	{{0x38,0x0b},{0xe0}},
	{{0x38,0x0c},{0x07}},
	{{0x38,0x0d},{0x68}},
	{{0x38,0x0e},{0x03}}, //0x3
	...
	{{0x30,0x08},{0x02}},
	{{0x35,0x03},{0x00}},
	{{0x48,0x00},{0x04|(1<<5)|(0<<4)}}, //bit4:line sync bi5:gat clock when no packing

	//mipi timing
	{{0x48,0x24},{0x00}}, //min value of lpx_p h
	{{0x48,0x25},{0x32}}, //min value of lpx_p l
	{{0x48,0x26},{0x00}}, //min value of hs_prepare h
	{{0x48,0x27},{0x32}}, //min value of hs_prepare l
	{{0x48,0x18},{0x00}}, //hs zero h
	{{0x48,0x19},{0x96}}, //hs zero l
	{{0x48,0x1a},{0x00}}, //min value of hs trail h
	{{0x48,0x1b},{0x3c}}, //min value of hs trail l
	{{0x48,0x28},{0x00}}, //min value of hs_exit h
	{{0x48,0x29},{0x64}}, //min value of hs_exit l
	{{0x48,0x1c},{0x01}}, //min value of clk_zero h
	{{0x48,0x1d},{0x86}}, //min value of clk_zero l
	{{0x48,0x1e},{0x00}}, //min value of clk_prepare h
	{{0x48,0x1f},{0x3c}}, //min value of clk_prepare l 0x003c
	{{0x48,0x20},{0x02}}, //min value of clk_post h
	{{0x48,0x21},{0x56}}, //min value of clk_post l
	{{0x48,0x22},{0x00}}, //min value of clk_trail h
	{{0x48,0x23},{0x3c}}, //min value of clk_trail l
	{{0x48,0x2a},{0x05}}, //min ui value of hs_zero 
	{{0x48,0x2b},{0x04}}, //min ui value of hs_trail
	{{0x48,0x2c},{0x00}}, //min ui value of clk_zero
	{{0x48,0x2d},{0x00}}, //min ui value of clk_prepare
	{{0x48,0x2e},{0x34}}, //min ui value of clk_post
	{{0x48,0x2f},{0x00}}, //min ui value of clk_trail
	{{0x48,0x30},{0x00}}, //min ui value of lpx_p(pclk2x domain)
	{{0x48,0x31},{0x04}}, //min ui value of hs_prepare
	{{0x48,0x32},{0x04}}, //min ui value of hs_exit

//	{{0x30,0x07},{0xff}},//enable MIPI clock
};                                	                         
...
//	{{0x30,0x08},{0x42}},
  ...
  {{0x30,0x35},{0x61}},                         
	...
	//banding step                                        
	{{0x3a,0x08},{0x00}}, //50HZ step MSB                 
	{{0x3a,0x09},{0x31}}, //50HZ step LSB                 
	{{0x3a,0x0a},{0x00}}, //60HZ step MSB                 
	{{0x3a,0x0b},{0x29}}, //60HZ step LSB                 
	{{0x3a,0x0e},{0x28}}, //50HZ step max                 
	{{0x3a,0x0d},{0x30}}, //60HZ step max 
#endif
...
//	//pll and clock setting
	{{0x30,0x34},{0x18}},                
#ifndef FPGA
	{{0x30,0x35},{0x21}}, //0x21:30fps 0x41:15fps
#else
	{{0x30,0x35},{0x81}}, //0x21:30fps 0x41:15fps 0x81:7.5fps
#endif               
	{{0x30,0x36},{0x70}},                
	{{0x30,0x37},{0x13}},                
	{{0x31,0x08},{0x01}},                
...
static struct regval_list sensor_fmt_mipi_yuv422[] = {
	{{0x30,0x34},{0x18}},
	{{0x43,0x00},{0x32}},//yuyv seq  //bit[7:4] 3:yuv422 4:yuv420
};

static struct regval_list sensor_fmt_mipi_raw8[] = {
	{{0x30,0x34} ,{0x18}}, 
	{{0x43,0x00} ,{0x02}},//bit[3:0] 0:BGGR 1:GBRG 2:GRBG 3:RGGB
};              

static struct regval_list sensor_fmt_mipi_raw10[] = {
	{{0x30,0x34},{0x1a}},
	{{0x43,0x00},{0x02}},//bit[3:0] 0:BGGR 1:GBRG 2:GRBG 3:RGGB
};
...
//	},
	{
		.desc		= "MIPI YUV422",
		.mbus_code	= V4L2_MBUS_FMT_UYVY8_1X1,
	...
	{
		.desc		= "MIPI RAW8",
		.mbus_code	= V4L2_MBUS_FMT_SBGGR8_1X1,
		.regs 		= sensor_fmt_mipi_raw8,
		.regs_size = ARRAY_SIZE(sensor_fmt_mipi_raw8),
		.bpp		= 1,
	},
	{
		.desc		= "MIPI RAW10",
		.mbus_code	= V4L2_MBUS_FMT_SBGGR10_1X1,
		.regs 		= sensor_fmt_mipi_raw10,
		.regs_size = ARRAY_SIZE(sensor_fmt_mipi_raw10),
		.bpp		= 2,
	},
};
