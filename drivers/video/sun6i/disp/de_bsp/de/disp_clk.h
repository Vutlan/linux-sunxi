...
#define  AW_MOD_CLK_AHB_DEBE0 AW_AHB_CLK_DEBE0 
#define  AW_MOD_CLK_AHB_DEBE1 AW_AHB_CLK_DEBE1 
#define  AW_MOD_CLK_AHB_DEFE0 AW_AHB_CLK_DEFE0 
#define  AW_MOD_CLK_AHB_DEFE1 AW_AHB_CLK_DEFE1 
#define  AW_MOD_CLK_AHB_LCD0  AW_AHB_CLK_LCD0  
#define  AW_MOD_CLK_AHB_LCD1  AW_AHB_CLK_LCD1  
#define  AW_MOD_CLK_AHB_TVE0  AW_CCU_CLK_CNT 
#define  AW_MOD_CLK_AHB_TVE1  AW_CCU_CLK_CNT
#define  AW_MOD_CLK_AHB_HDMI  AW_AHB_CLK_HDMID

#define AW_MOD_CLK_SDRAM_DEBE0 AW_DRAM_CLK_DEBE0
#define AW_MOD_CLK_SDRAM_DEBE1 AW_DRAM_CLK_DEBE1
#define AW_MOD_CLK_SDRAM_DEFE0 AW_DRAM_CLK_DEFE0
#define AW_MOD_CLK_SDRAM_DEFE1 AW_DRAM_CLK_DEFE1

#define AW_MOD_CLK_LCD0CH1_S1  AW_MOD_CLK_LCD0CH1
#define AW_MOD_CLK_LCD0CH1_S2  AW_MOD_CLK_LCD0CH1
#define AW_MOD_CLK_LCD1CH1_S1  AW_MOD_CLK_LCD1CH1
#define AW_MOD_CLK_LCD1CH1_S2  AW_MOD_CLK_LCD1CH1
