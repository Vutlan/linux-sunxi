...
__s32 tcon0_cfg(__u32 sel, __panel_para_t * panel)
{
    ...
    tcon_gamma(sel,panel->lcd_extend_para.lcd_gamma_en,panel->lcd_extend_para.lcd_gamma_tbl);
	tcon_cmap(sel,panel->lcd_extend_para.lcd_cmap_en,panel->lcd_extend_para.lcd_cmap_tbl);
