 ...
 * evb gpio define
 * A10 gpio define:
 *  8 - bcm40183 sdio wifi gpio config
 * bcm40183_pwr           = port:PA01<1><default><default><0>
 * bcm40183_wl_regon      = port:PA02<1><default><default><0>
 * bcm40183_bt_rst        = port:PA03<1><default><default><0>
 * bcm40183_bt_regon      = port:PA04<1><default><default><0>
 */
