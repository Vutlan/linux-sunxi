				  ...
				  unsigned long arg)
{
	...
	//printk(KERN_WARNING "[cedar] ioctl %d\n", cmd);
...
static struct cedar_variant sun8i_r40_quirk = {
	.capabilities = 0,
	.mod_rate = 360000000,
};
...
static struct of_device_id sunxi_cedar_ve_match[] = {
	...
	{ .compatible = "allwinner,sun8i-r40-cedar", .data = &sun8i_r40_quirk },
