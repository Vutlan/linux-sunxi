 ...
 */
char firmware_path[MOD_PARAM_PATHLEN] = "/system/vendor/modules/bcm40181_sdio_wapi.bin";
char nvram_path[MOD_PARAM_PATHLEN] = "/system/vendor/modules/bcm40181_nvram.txt";
...
static char dhd_version[] = "<3>Dongle Host Driver, version " EPI_VERSION_STR
#ifdef DHD_DEBUG
